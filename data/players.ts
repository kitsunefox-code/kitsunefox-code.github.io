...
// MLB さらに追加（150名超え・中堅/若手/救援）
const MLB_RAW3: MRec[] = [
  { name: "ウィリー・アダメス", pos: "遊撃手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "defense"], note: "長打力と守備を兼ね備えた遊撃手。" },
  { name: "ブライソン・ストット", pos: "二塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "speed"], note: "俊足と確実性が持ち味の若手二塁手。" },
  { name: "アレック・ボーム", pos: "三塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact"], note: "勝負強い打撃が魅力の三塁手。" },
  { name: "ジャレン・デュラン", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["speed", "power"], note: "俊足とパワーを兼ね備えた外野手。" },
  { name: "ライリー・グリーン", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "power"], note: "打撃センス抜群の若手外野手。" },
  { name: "エバン・カーター", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact"], note: "選球眼に優れる有望な外野手。" },
  { name: "コルト・キース", pos: "二塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "power"], note: "打撃を売りにする若手内野手。" },
  { name: "ジョナサン・インディア", pos: "二塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "speed"], note: "出塁能力の高いリードオフ二塁手。" },
  { name: "マイク・ヤストレムスキー", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact"], note: "巧打と選球眼が持ち味の外野手。" },
  { name: "ハンター・レンフロー", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power"], note: "強肩とパワーが魅力の右翼手。" },
  { name: "コール・レイガンス", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "急成長した左のパワーピッチャー。" },
  { name: "ギャレット・クロシェ", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "剛速球が武器の左腕エース。" },
  { name: "ブライアン・ウー", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "威力ある速球を投げ込む若手右腕。" },
  { name: "クリスチャン・ハビエル", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "浮き上がる速球と制球が武器の右腕。" },
  { name: "タナー・バイビー", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "多彩な変化球を操る先発右腕。" },
  { name: "セス・ルーゴ", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "球種の多さで勝負するベテラン右腕。" },
  { name: "マイケル・キング", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "先発転向で開花した力のある右腕。" },
];

// MLB さらに追加（150名超え・現役中堅/クローザー/先発）
const MLB_RAW4: MRec[] = [
  { name: "ブランドン・ニモ", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "speed"], note: "出塁率の高いリードオフ型の外野手。" },
  { name: "イアン・ハップ", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "power"], note: "スイッチの中距離打者。守備も堅実。" },
  { name: "マイケル・コンフォート", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power"], note: "長打力が魅力の左の外野手。" },
  { name: "アンドリュー・ヴォーン", pos: "一塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power"], note: "パワーが持ち味の右の一塁手。" },
  { name: "ジョシュ・ネイラー", pos: "一塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "clutch"], note: "勝負強い打撃と闘志が魅力の一塁手。" },
  { name: "ボー・ビシェット", pos: "遊撃手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "power"], note: "積極的な打撃が持ち味の遊撃手。" },
  { name: "ハビアー・バエズ", pos: "遊撃手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["defense", "power", "flashy"], note: "魔術的な守備とタッチプレーで魅せる遊撃手。" },
  { name: "ギャビン・ラックス", pos: "二塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact"], note: "巧打と柔らかい守備が持ち味の内野手。" },
  { name: "ブレンダン・ドノバン", pos: "二塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "defense"], note: "複数ポジションを守れる巧打のユーティリティ。" },
  { name: "マット・ヴィアーリング", pos: "三塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "defense"], note: "堅守と勝負強さを備えたユーティリティ。" },
  { name: "クリスチャン・バスケス", pos: "捕手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["catcher", "defense"], note: "守備とリードに定評のある捕手。" },
  { name: "ネイサン・イオバルディ", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "威力ある速球を投げ込むベテラン右腕。" },
  { name: "マイルズ・マイコラス", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "制球と球種で勝負する技巧派。日本球界でも活躍。" },
  { name: "ロビー・レイ", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "奪三振能力の高いサイ・ヤング左腕。" },
  { name: "ショーン・マナイア", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "変則的な角度から投げ込む左腕。" },
  { name: "カイル・ハリソン", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "奪三振が魅力の若手左腕。" },
];

// NPB レジェンド 追加バッチ（往年の名選手）
const NPB_LEGENDS2_RAW: MRec[] = [
  { name: "稲葉篤紀", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "contact", "leader"], note: "日本ハムの主軸として活躍。のちに侍ジャパン監督。" },
  { name: "高橋由伸", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "contact", "star"], note: "美しいスイングの巨人の主砲。" },
  { name: "岩村明憲", pos: "三塁手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "contact"], note: "日米で活躍した勝負強い内野手。" },
  { name: "二岡智宏", pos: "遊撃手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "clutch"], note: "打てる遊撃手として巨人で活躍。" },
  { name: "今岡誠", pos: "三塁手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["contact", "clutch"], note: "打点王を獲得した阪神の巧打者。" },
  { name: "矢野燿大", pos: "捕手", glove: "ゼット", bat: "ゼット", spikes: "ゼット", traits: ["catcher", "leader", "clutch"], note: "阪神の正捕手として活躍。のちに監督も。" },
  { name: "野村克也", pos: "捕手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["catcher", "leader", "technician", "star"], note: "ID野球の祖。戦後屈指の打てる捕手。" },
  { name: "田淵幸一", pos: "捕手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["catcher", "power", "star"], note: "豪快な本塁打が魅力の強打の捕手。" },
  { name: "山本浩二", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "leader", "star"], note: "ミスター赤ヘル。広島黄金期の主砲。" },
  { name: "衣笠祥雄", pos: "三塁手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "stoic", "star"], note: "鉄人の異名を持つ連続試合出場記録の主。" },
  { name: "張本勲", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["contact", "power", "star"], note: "通算3085安打の安打製造機。" },
  { name: "福本豊", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["speed", "star"], note: "世界の盗塁王。俊足で一時代を築いた。" },
  { name: "若松勉", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["contact", "technician"], note: "小さな大打者と呼ばれた首位打者。" },
  { name: "有藤通世", pos: "三塁手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "leader"], note: "ミスターロッテと称された三塁手。" },
  { name: "大杉勝男", pos: "一塁手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "clutch"], note: "東映・ヤクルトで活躍した長距離砲。" },
  { name: "江夏豊", pos: "投手", glove: "ミズノ", spikes: "ミズノ", traits: ["pitcher", "power", "clutch", "star"], note: "江夏の21球で知られる伝説の左腕。" },
  { name: "金田正一", pos: "投手", glove: "ミズノ", spikes: "ミズノ", traits: ["pitcher", "power", "star"], note: "通算400勝の大投手。金田の異名は永遠。" },
  { name: "稲尾和久", pos: "投手", glove: "ミズノ", spikes: "ミズノ", traits: ["pitcher", "stoic", "star"], note: "神様仏様稲尾様。西鉄黄金期の鉄腕。" },
  { name: "山田久志", pos: "投手", glove: "ミズノ", spikes: "ミズノ", traits: ["pitcher", "technician", "star"], note: "アンダースローの名投手。阪急のエース。" },
  { name: "東尾修", pos: "投手", glove: "ミズノ", spikes: "ミズノ", traits: ["pitcher", "technician", "leader"], note: "喧嘩投法で知られた西武のエース。" },
  { name: "北別府学", pos: "投手", glove: "ミズノ", spikes: "ミズノ", traits: ["pitcher", "technician"], note: "精密な制球で200勝を挙げた広島のエース。" },
...
// MLB さらに追加（中堅・専門職）
const MLB_RAW6: MRec[] = [
  { name: "ジョナ・ハイム", pos: "捕手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["catcher", "power"], note: "打てるスイッチ捕手。ワールドシリーズ制覇の女房役。" },
  { name: "アレハンドロ・カーク", pos: "捕手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["catcher", "contact"], note: "小柄ながらミート力の高い巧打の捕手。" },
  { name: "TJ・フリードル", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["speed", "contact"], note: "俊足と出塁力が武器のリードオフ外野手。" },
  { name: "ジェイク・マイヤーズ", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["defense"], note: "守備範囲の広い堅守の中堅手。" },
  { name: "アイザック・パレデス", pos: "三塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power"], note: "引っ張りの本塁打が得意な右の三塁手。" },
  { name: "スペンサー・スティア", pos: "三塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "power"], note: "複数ポジションをこなす中距離打者。" },
  { name: "ブランドン・マーシュ", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "defense"], note: "パワーと守備を備えた個性派の外野手。" },
  { name: "ラモン・ウリアス", pos: "内野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["defense"], note: "ゴールドグラブ受賞歴のある内野の名手。" },
  { name: "マイルズ・ストロー", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["speed", "defense"], note: "俊足と守備が売りの中堅手。" },
  { name: "クリスチャン・エンカーナシオン=ストランド", pos: "一塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power"], note: "規格外のパワーを秘めた若手一塁手。" },
  { name: "ジェフリー・スプリングス", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "チェンジアップが武器の技巧派左腕。" },
  { name: "エドゥアルド・ロドリゲス", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "安定感のあるベテラン左腕。" },
  { name: "マーカス・ストローマン", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "ゴロを打たせる小さな巨人。制球派の右腕。" },
  { name: "ランス・リン", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "力で押すベテランのイニングイーター。" },
  { name: "カイル・フィネガン", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "clutch"], note: "終盤を任される安定した右の守護神。" },
];

// NPB 名選手 追加バッチ（2000年代の主力・往年の名選手）
const NPB_LEGENDS4_RAW: MRec[] = [
  { name: "村田修一", pos: "三塁手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "clutch"], note: "横浜・巨人で活躍した右の長距離砲。本塁打王2回。" },
  { name: "多村仁志", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "contact"], note: "美しいスイングの浜の主砲。故障が惜しまれた才能。" },
  { name: "栗原健太", pos: "一塁手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "clutch"], note: "広島で中軸を担った右の強打者。" },
  { name: "嶋基宏", pos: "捕手", glove: "ゼット", bat: "ゼット", spikes: "ゼット", traits: ["catcher", "leader"], note: "楽天日本一を支えた頭脳派の正捕手。「見せましょう」の名演説。" },
  { name: "相川亮二", pos: "捕手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["catcher"], note: "横浜・ヤクルト・巨人で長く活躍した堅実な捕手。" },
  { name: "今江敏晃", pos: "内野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["contact", "clutch"], note: "ロッテのポストシーズン男。勝負強い巧打者。" },
  { name: "サブロー", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["contact"], note: "ロッテ一筋の勝負強い巧打の外野手。" },
  { name: "鉄平", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["contact"], note: "楽天で首位打者を獲得した安打製造機。" },
  { name: "門田博光", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "star"], note: "不惑の大砲。40歳で本塁打王に輝いた鉄人スラッガー。" },
  { name: "大島康徳", pos: "内野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power"], note: "中日・日本ハムで活躍した長距離砲。" },
  { name: "谷沢健一", pos: "外野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["contact", "technician"], note: "中日の首位打者。理論派の巧打者。" },
  { name: "宇野勝", pos: "遊撃手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "flashy"], note: "打てる遊撃手の先駆け。ヘディング事件でも有名。" },
  { name: "高木守道", pos: "二塁手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["defense", "speed"], note: "華麗な守備の中日の名二塁手。" },
  { name: "ブーマー・ウェルズ", pos: "一塁手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["power", "contact"], note: "阪急の助っ人三冠王。パワーと確実性を兼備。" },
  { name: "大石大二郎", pos: "内野手", glove: "ミズノ", bat: "ミズノ", spikes: "ミズノ", traits: ["speed"], note: "近鉄の俊足リードオフマン。盗塁王4回。" },
];

// MLB さらに追加（現役の主力・注目株を厚めに収録）
const MLB_RAW7: MRec[] = [
  { name: "フリオ・ロドリゲス", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "speed", "flashy", "star"], note: "マリナーズの顔。パワーとスピードを兼ね備えた次世代の看板打者。" },
  { name: "ルイス・アラエズ", pos: "一塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "technician"], note: "3年連続で首位打者級の打率を残すヒットメーカー。" },
  { name: "ウィル・スミス", pos: "捕手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["catcher", "power", "clutch"], note: "ドジャースの正捕手。勝負強い打撃でも貢献する。" },
  { name: "JP・クロフォード", pos: "遊撃手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["defense", "leader"], note: "堅実な守備でマリナーズの内野を締める主将格。" },
  { name: "エロイ・ヒメネス", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power"], note: "パワー自慢のスラッガー。一発で試合を変える。" },
  { name: "アンドルー・マカッチェン", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["leader", "contact", "star"], note: "パイレーツ一筋のベテラン。MVP経験の精神的支柱。" },
  { name: "ホルヘ・ソレアー", pos: "指名打者", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "clutch"], note: "ポストシーズンに強い一発長打の職人。" },
  { name: "ミゲル・ロハス", pos: "遊撃手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["defense", "leader"], note: "堅実な守備とベテランの安定感が光る内野手。" },
  { name: "エゼキエル・トーバー", pos: "遊撃手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "defense"], note: "パワーと守備範囲を兼ねる若手ショート。" },
  { name: "ブレントン・ドイル", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["defense", "speed"], note: "ゴールドグラブ級の守備範囲を誇る中堅手。" },
  { name: "ジェイク・クローネンワース", pos: "内野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact", "defense"], note: "複数ポジションをこなす堅実なユーティリティ。" },
  { name: "トミー・エドマン", pos: "内野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["defense", "speed", "flashy"], note: "内外野を守る万能選手。ポストシーズンでも活躍。" },
  { name: "ライアン・マックマーン", pos: "三塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "defense"], note: "堅い守備とパンチ力を兼ねる三塁手。" },
  { name: "マーセル・オズナ", pos: "指名打者", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "clutch"], note: "中軸を任される長距離砲。勝負強さも兼備。" },
  { name: "リース・ホスキンス", pos: "一塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power"], note: "豪快なバットフリップでも知られるパワー一塁手。" },
  { name: "ニック・カステヤノス", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "contact"], note: "積極的な打撃スタイルの右の強打者。" },
  { name: "フランシスコ・アルバレス", pos: "捕手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["catcher", "power", "star"], note: "強打の若き正捕手。メッツの将来を担う逸材。" },
  { name: "ノーラン・シャヌエル", pos: "一塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact"], note: "選球眼に優れる若手一塁手。" },
  { name: "デビッド・ペラルタ", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["contact"], note: "勝負強い巧打が持ち味のベテラン外野手。" },
  { name: "コナー・ウォン", pos: "捕手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["catcher", "speed"], note: "捕手ながら俊足も兼ね備えるレッドソックスの正捕手。" },
  { name: "ダニー・ジャンセン", pos: "捕手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["catcher", "power"], note: "長打力のあるブルージェイズの捕手。" },
  { name: "パトリック・ウィズダム", pos: "三塁手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power"], note: "一発の魅力があるカブスの三塁手。" },
  { name: "ジョーダン・ウォーカー", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "contact"], note: "カージナルスの次世代を担う長打型外野手。" },
  { name: "ジェームズ・アウトマン", pos: "外野手", glove: "ローリングス", bat: "マルーチ", spikes: "ナイキ", traits: ["power", "speed"], note: "パワーとスピードを併せ持つドジャースの外野手。" },
  { name: "シェーン・ビーバー", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician", "star"], note: "サイ・ヤング賞右腕。制球と奪三振能力を兼備。" },
  { name: "ジャスティン・スティール", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "スライダーを武器にするカブスの左腕エース。" },
  { name: "ハンター・グリーン", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "100マイル超を連発するレッズの剛腕先発。" },
  { name: "ホセ・ベリオス", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician", "leader"], note: "安定した投球でローテーションを支えるベテラン。" },
  { name: "ルーカス・ジオリート", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "多彩な変化球を操る先発右腕。" },
  { name: "アレック・マノア", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "長身から投げ下ろす剛腕右腕。" },
  { name: "ジョーダン・モンゴメリー", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "テンポの良い投球が持ち味の左腕。" },
  { name: "カルロス・エステベス", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "clutch"], note: "終盤を締める安定したリリーバー。" },
  { name: "ライアン・プレスリー", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "clutch", "star"], note: "キレのあるカーブが武器のアストロズ守護神。" },
  { name: "ジョーダン・ロマーノ", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "clutch"], note: "力のある速球で抑えるクローザー。" },
  { name: "フランキー・モンタス", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "power"], note: "スプリットを武器にする力のある右腕。" },
  { name: "カイル・ブラディッシュ", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "多彩な球種を持つオリオールズの若手右腕。" },
  { name: "マシュー・ボイド", pos: "投手", glove: "ローリングス", spikes: "ナイキ", traits: ["pitcher", "technician"], note: "復活を遂げたベテラン左腕。" },
];

const MLB_CURATED: Player[] = [...MLB_RAW, ...MLB_RAW2, ...MLB_RAW3, ...MLB_RAW4, ...MLB_RAW5, ...MLB_RAW6, ...MLB_RAW7].map((m) => ({
  name: m.name,
  league: "MLB" as const,
  position: m.pos,
  glove: m.glove,
...
const NPB_LEGENDS: Player[] = [...NPB_LEGENDS_RAW, ...NPB_LEGENDS2_RAW, ...NPB_LEGENDS3_RAW, ...NPB_LEGENDS4_RAW].map((m) => ({
  name: m.name,
  league: "NPB" as const,
  position: m.pos,
  glove: m.glove,
