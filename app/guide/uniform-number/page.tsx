...
export const metadata: Metadata = {
  ...
  description:
    "背番号決めは、意外と盛り上がって、ちょっと揉める。プロで有名な番号の意味、ポジション別の伝統、人気番号、チーム内で揉めない決め方、リーグの番号ルールまで、発注前に知っておきたいことをまとめました。",
  alternates: { canonical: `${SITE_URL}/guide/uniform-number/` },
  openGraph: {
    title: "草野球の背番号の決め方【人気番号・意味・ルール】",
    description:
      "エースナンバー18の由来から、揉めない決め方・発注前の注意点まで。背番号の全知識。",
    type: "article",
  },
};
  ...
  return (
    <main className="container">
      ...
      <article className="article">
        ...
        <p>
          ユニフォームを作るとき、地味に盛り上がる——そして、ちょっと揉めるのが背番号決めです。
          「1番がいい」「いや俺こそ」と、大人が真顔で言い合う光景は、草野球ならではの名物。
        </p>
        <p>
          背番号は、その人の“キャラ”を背中に背負うようなもの。
          だからこそ、この記事では<strong>番号に込められた意味と伝統</strong>、
          <strong>草野球で人気の番号</strong>、そして<strong>チームで揉めずに決めるコツ</strong>まで、
          発注ボタンを押す前に知っておきたいことを、まるっと解説します。
        </p>

        <AdSlot id="article-top" />

        <h2>まず知っておきたい、背番号の“意味”</h2>
        <p>
          日本の野球では、番号ごとに「らしさ」の伝統があります。
          その伝統を守るもよし、あえて外して個性を出すもよし。まずは代表的なものから。
        </p>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr><td><strong>18</strong></td><td>エースナンバー（投手の最高峰）</td><td>田中将大、山本由伸</td></tr>
            <tr><td><strong>51</strong></td><td>特別なスターの番号</td><td>イチロー</td></tr>
            <tr><td><strong>55</strong></td><td>ホームランバッター</td><td>松井秀喜、秋山翔吾</td></tr>
          </tbody>
        </table>
        <div className="point-box">
          <strong>豆知識：</strong>
          エースナンバー「18」の由来は諸説ありますが、歌舞伎の「十八番（おはこ）＝最も得意な芸」
          から来ている、という説が有名です。エースに背負わせるのにぴったりの由来ですね。
        </div>

        <h2>草野球で人気の番号と、その傾向</h2>
        <p>
          プロの伝統とは別に、草野球ならではの人気番号もあります。争奪戦になりがちなのはこのあたり。
        </p>
        <ul>
          <li><strong>1・7・18・51</strong>：どのチームでも取り合いになる“四強”</li>
          <li><strong>誕生日番号</strong>（例：6月24日→24）：理由が明快で、被っても譲り合いやすい</li>
          <li><strong>ゾロ目（11・22・33…）</strong>：見た目が良く、昇華プリントでも映える</li>
          <li><strong>0・00</strong>：使えるリーグなら個性派に人気（連盟によっては不可）</li>
          <li><strong>好きなプロ選手と同じ番号</strong>：草野球の王道。飲み会での話のネタにもなります</li>
        </ul>

        <h2>発注前にチェック：リーグ・連盟のルール</h2>
        <p>
          自由に決めたあとで「その番号ダメでした」となると、作り直しの悲劇。先に確認しておきましょう。
        </p>
        <ul>
          <li>多くの軟式連盟では<strong>0〜99の整数</strong>が基本。「00」や3桁は不可のことも</li>
          <li>大会によっては<strong>監督30・主将10</strong>など役職番号の指定がある（高校野球系の慣習）</li>
          <li>同一チーム内の<strong>番号重複は不可</strong>。発注前にリーグ規定を必ず確認</li>
        </ul>
        ...
        <ol>
          <li>
            ...
            LINEやスプレッドシートで「第3希望まで」書いてもらい、早い者勝ち。いちばんシンプル
          </li>
          <li>
          ...
          <li>
            ...
            エースに18、捕手に2、主将に10を先に確保→残りは自由。野球らしさ重視のチーム向け
          </li>
        </ol>
        <div className="point-box">
          <strong>発注前の最終チェック：</strong>
          番号決定後は、<strong>全員の番号一覧を書面（LINEノート等）で確認</strong>してから発注を。
          「28と29を取り違えた」は毎年どこかで起きる、笑えない事故です。
          発注後の変更は作り直し＝追加費用になります。
        </div>
        ...
        <RelatedGuides currentHref="/guide/uniform-number/" />
      </article>
      <GoodsLinks />
      <div style={{ height: 30 }} />
    </main>
