...
export async function generateMetadata({
  ...
  const desc = `${t.catch} ${t.code}（${t.nickname}）型の特徴・相性の良いタイプ／苦手なタイプ・似ているNPB/MLB選手を紹介。あなたのタイプは無料の「野球人間ドック」でチェックできます。`;
  const url = `${SITE_URL}/baseball-dock/type/${t.code.toLowerCase()}/`;
...
export default async function MbtiTypePage({
  ...
  const jsonLd = {
    ...
    description: t.catch,
    mainEntityOfPage: `${SITE_URL}/baseball-dock/type/${t.code.toLowerCase()}/`,
    ...
    <main>
      ...
      <div className="hero" style={{ padding: "30px 0 24px" }}>
        <div className="container">
          <p className="crumbs">
            <a href="/baseball-dock/">野球選手MBTI診断</a> ›{" "}
            <a href="/baseball-dock/type/">タイプ一覧</a> › {t.code}
          </p>
      ...
      <div className="container" style={{ paddingTop: 20 }}>
          ...
          <div className="compat-grid">
            {compat.best && (
              <a
                ...
                href={`/baseball-dock/type/${compat.best.type.code.toLowerCase()}/`}
              >
            ...
            {compat.tough && (
              <a
                ...
                href={`/baseball-dock/type/${compat.tough.type.code.toLowerCase()}/`}
              >
        ...
        <a className="start-band" href="/baseball-dock/">
          <div
          ...
          <div className="type-hub-grid">
            {others.map((x) => (
              <a
                ...
                href={`/baseball-dock/type/${x.code.toLowerCase()}/`}
              >
        ...
        <div className="bat-links" style={{ paddingBottom: 40 }}>
          <a className="cta-inline" href="/hikaku/">→ 道具・ユニフォーム比較を見る</a>
